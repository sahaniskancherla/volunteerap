...
<script src="js/main.js"></script> <!-- Gem jQuery -->
    ...
    <div class="brand"><a href="owner.php" style='text-decoration:none;'>VolunteerAP</a>
	...
	<div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
        ...
        <div class="container">
            ...
            <div class="navbar-header" style='background: #2980B9;'>
			                <div class="navbar-brand"  style='color: #ffffff;'><center>VolunteerAP</center></div>
               <div id="mySidenav" class="sidenav" style='background-color:#fff;'>
			  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                        <a href="owner.php">Add Instituions</a>
                        <a href="addnews.php">Add News & Updates</a>

...
<script src="js/main.js"></script> <!-- Gem jQuery -->
    ...
    <div class="brand"><a href="user.php" style='text-decoration:none;'>VolunteerAP</a>
<nav class="main-nav">
			<ul>
    ...
    <div class="address-bar"><br></div>
        ...
        <div class="container">
            ...
            <div class="navbar-header" style='background: #2980B9;'>
			                <div class="navbar-brand" style='background-color:#2980B9;color:#fff;' >VolunteerAP</div>

				<div class="mob">				
				<ul>								
				<li><a class="cd-switcher" href="logout.php"><span class="glyphicon glyphicon-log-in" ></span> Logout</a></li>
				</ul>
				</div>
			...
			<div id="mySidenav" class="sidenav" style='background-color:#fff;'>
			  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                        ...
                        <a href="myvisits.php">My Visits</a>
                        <a href="search.php">Get Registered</a>			  
			</div> 

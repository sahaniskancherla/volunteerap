    ...
    <div class="container">
        <div class="row">
            <div class="box">
				...
				<?php
					$query = "SELECT * FROM  `registration` WHERE upper(`institute`) = '".strtoupper($institute_name)."'and `accepted` = 1 ORDER BY `time`";
					$table = mysqli_query($conn,$query);
					while($row = mysqli_fetch_row($table))
					{
						...
						<hr>
						</td><td><br><br><b><a href="requests.php?tableid='.$tableid.'&key=2&page=2"><font size="3px" color="#228B22">CONFIRM</a></font></b><br><br><b><a href="requests.php?tableid='.$tableid.'&key=-1&page=2"><font size="3px" color="	#8B0000">REJECT</a></font></b></td></tr>';
					}
				?>	
				</table>
